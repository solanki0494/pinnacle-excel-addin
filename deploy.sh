...
<body>
    ...
    <div class="card">
        ...
        <div class="feature">
            ...
            <span>Copies cashflow data from <strong>"Outputs"</strong> sheet to <strong>"Software Engineer Cash Flow"</strong> sheet</span>
        </div>
        <div class="feature">
            <span class="feature-icon">🔄</span>
            <span>Forces Excel recalculation to ensure data is current</span>
        </div>
        <div class="feature">
            <span class="feature-icon">⚡</span>
            <span>One-click operation via ribbon button</span>
        </div>
    </div>
