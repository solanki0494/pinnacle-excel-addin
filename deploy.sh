...
<body>
    ...
    <div class="card">
        ...
        <div class="feature">
            ...
            <span>Copy Outputs sheet cashflow to Engineering sheet cashflow</span>
        </div>
        <div class="feature">
            <span class="feature-icon">🔄</span>
            <span>Forces Excel recalculation before copying</span>
        </div>
        <div class="feature">
            <span class="feature-icon">🎯</span>
            <span>Simple ribbon button interface</span>
        </div>
    </div>
